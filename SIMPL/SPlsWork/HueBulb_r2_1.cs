...
namespace UserModule_HUEBULB_R2_1
{
    public class UserModuleClass_HUEBULB_R2_1 : SplusObject
    {
...
public UserModuleClass_HUEBULB_R2_1 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
