...
namespace UserModule_HUEBULB_R2_3
{
    public class UserModuleClass_HUEBULB_R2_3 : SplusObject
    {
        ...
        Crestron.Logos.SplusObjects.AnalogInput CTIN;
        ...
        Crestron.Logos.SplusObjects.AnalogOutput CTOUT;
...
object CTIN_OnChange_7 ( Object __EventInfo__ )
    ...
    try
    {
        ...
        MYLIGHT . LightsVal ( "ct", (ushort)( CTIN  .UshortValue )) ; 
        __context__.SourceCodeLine = 83;
        CTOUT  .Value = (ushort) ( MYLIGHT.BulbCt ) ; 
...
public void MYCTHANDLER ( object __sender__ /*HueLights.HueLight SENDER */, EventArgs ARGS ) 
    { 
    HueLight  SENDER  = (HueLight )__sender__;
    try
    {
...
public void MYLIGHTHANDLER ( object __sender__ /*HueLights.HueLight SENDER */, EventArgs ARGS ) 
    ...
    try
    {
        ...
        if ( Functions.TestForTrue  ( ( MYLIGHT.Reachable)  ) ) 
            ...
            LOADISCOLOR  .Value = (ushort) ( MYLIGHT.BulbColor ) ; 
...
public override object FunctionMain (  object __obj__ ) 
    ...
    try
    {
        ...
        try { g_criticalSection.Enter(); MYLIGHT .BulbCtUpdate  += MYCTHANDLER; } finally { g_criticalSection.Leave(); }
        ; 
...
public override void LogosSplusInitialize()
{
    ...
    CTIN = new Crestron.Logos.SplusObjects.AnalogInput( CTIN__AnalogSerialInput__, this );
    m_AnalogInputList.Add( CTIN__AnalogSerialInput__, CTIN );
    ...
    CTOUT = new Crestron.Logos.SplusObjects.AnalogOutput( CTOUT__AnalogSerialOutput__, this );
    m_AnalogOutputList.Add( CTOUT__AnalogSerialOutput__, CTOUT );
    ...
    CTIN.OnAnalogChange.Add( new InputChangeHandlerWrapper( CTIN_OnChange_7, true ) );
...
public UserModuleClass_HUEBULB_R2_3 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
...
const uint CTIN__AnalogSerialInput__ = 3;
const uint LIGHTNAMELISTITEM__AnalogSerialInput__ = 4;
...
const uint CTOUT__AnalogSerialOutput__ = 4;
