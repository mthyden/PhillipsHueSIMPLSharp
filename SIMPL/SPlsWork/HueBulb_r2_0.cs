...
namespace UserModule_HUEBULB_R2_0
{
    public class UserModuleClass_HUEBULB_R2_0 : SplusObject
    {
...
public override void LogosSplusInitialize()
{
    ...
    LIGHTNAMELISTITEM = new Crestron.Logos.SplusObjects.StringInput( LIGHTNAMELISTITEM__AnalogSerialInput__, 20, this );
...
public UserModuleClass_HUEBULB_R2_0 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
